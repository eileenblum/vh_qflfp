...
\newpage
\noindent Lastly using the predicate unspec($x$) defined above, how can we define the two association functions needed to describe the ATR harmony pattern with blocking?
